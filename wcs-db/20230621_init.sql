...
CREATE TABLE IF NOT EXISTS `tastes` (
  ...
  `intensity_id` INT NOT NULL,
  PRIMARY KEY (`id`, `aromas_id`, `intensity_id`),
...
-- -----------------------------------------------------
-- Table `tasting_result_has_aromas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `tasting_result_has_aromas` ;

CREATE TABLE IF NOT EXISTS `tasting_result_has_aromas` (
  `tasting_result_id` INT NOT NULL,
  `aromas_id` INT NOT NULL,
  PRIMARY KEY (`tasting_result_id`, `aromas_id`),
  INDEX `fk_tasting_result_has_aromas_aromas1_idx` (`aromas_id` ASC) VISIBLE,
  INDEX `fk_tasting_result_has_aromas_tasting_result1_idx` (`tasting_result_id` ASC) VISIBLE,
  CONSTRAINT `fk_tasting_result_has_aromas_tasting_result1`
    FOREIGN KEY (`tasting_result_id`)
    REFERENCES `tasting_result` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tasting_result_has_aromas_aromas1`
    FOREIGN KEY (`aromas_id`)
    REFERENCES `aromas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `bottle_per_cepage_has_aromas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bottle_per_cepage_has_aromas` ;

CREATE TABLE IF NOT EXISTS `bottle_per_cepage_has_aromas` (
  `bottle_per_cepage_id` INT NOT NULL,
  `aromas_id` INT NOT NULL,
  PRIMARY KEY (`bottle_per_cepage_id`, `aromas_id`),
  INDEX `fk_bottle_per_cepage_has_aromas_aromas1_idx` (`aromas_id` ASC) VISIBLE,
  INDEX `fk_bottle_per_cepage_has_aromas_bottle_per_cepage1_idx` (`bottle_per_cepage_id` ASC) VISIBLE,
  CONSTRAINT `fk_bottle_per_cepage_has_aromas_bottle_per_cepage1`
    FOREIGN KEY (`bottle_per_cepage_id`)
    REFERENCES `bottle_per_cepage` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_bottle_per_cepage_has_aromas_aromas1`
    FOREIGN KEY (`aromas_id`)
    REFERENCES `aromas` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
